...
target_folder <- file.path(basedir, "Ref/quants/CM")
...
rownames(sampleDistMatrix) <- paste(rld$stim2, rld$pc, sep = " - " )
...
### distance MDS
```{r vis dim red bulk}
colCond <- c("#213782","grey","lightgrey","#822145")
names(colCond) <- c("BMP_24h","ctr_24h", "ctr_48h","BMP_48h")
...
colCond <- c("#213782","#822145","grey","lightgrey")
names(colCond) <- c("BMP_24h","BMP_48h", "ctr_24h", "ctr_48h")
...
sel_genes <- c("ENSG00000019991", "ENSG00000125378", "ENSG00000107779", "ENSG00000138696", "ENSG00000180875", "ENSG00000105976")
